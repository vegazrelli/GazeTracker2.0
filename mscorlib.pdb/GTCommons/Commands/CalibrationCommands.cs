...
namespace GTCommons.Commands
{
    public class CalibrationCommands : Window
    {
        ...
        public event StringEventHandler ParamChange;

        public event StringEventHandler AreaSizeChange;
        ...
        public void Parameters(string parameter)
        {
            try
            {
                this.OnParamChange(new StringEventArgs(parameter));
            }
            catch (Exception ex)
            {
            }
        ...
        public void AreaSize(int width, int height)
        {
            try
            {
                this.OnAreaSizeChange(new StringEventArgs(width + " " + height));
            }
            catch (Exception ex)
            {
            }
