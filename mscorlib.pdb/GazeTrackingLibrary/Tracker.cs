...
namespace GazeTrackingLibrary
{
    public class Tracker
    {
        ...
        public readonly GTGazeData gazeDataSmoothed;
        ...
        {
            return (this.gazeDataSmoothed.GazePositionX + " " + this.gazeDataSmoothed.GazePositionY);
        }
        ...
        public void CalibrationEnd()
        {
            try
            {
                ...
                server.SendMessage(GazeTrackerClient.Commands.CalibrationEnd, 5); // todo: should be quality
            }
            catch (Exception ex)
            {
